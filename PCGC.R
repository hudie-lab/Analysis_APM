...
## function to obtain the PCGC estimators (Golan et al. 2014 PNAS) on case-control studies of the heritabilities 
...
PCGC <- function(dir,K){
  ...
  return(list(est_h2=fit_pcgc_fix$coefficients, esti_asyp_sd=sqrt(diag(inver_sum_XTX )) ))
